...
import { PhoneCall, Mail, Facebook, Instagram, Phone, MessageCircleMore, MapPin } from "lucide-react"
    ...
    <footer className="bg-[#185519] text-white py-8 px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div className="text-center text-2xl md:text-sm md:text-left space-y-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors duration-200">
          ...
          <p className="text-xl font-semibold text-white/90">Muhammad Naeem</p>
        ...
        <div className="text-center text-2xl md:text-sm md:text-left space-y-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors duration-200">
          ...
          <p className="text-xl font-semibold text-white/90">Ahmed Naeem</p>
          <div className="flex flex-col gap-3">
            <p className="flex items-center justify-center md:justify-start gap-3 text-base">
              <PhoneCall className="w-5 h-5 text-white/60" />
        ...
        {/* Office */}
        <div className="text-center text-2xl md:text-sm md:text-left space-y-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors duration-200">
          <h3 className="text-2xl font-bold mb-4 text-white/90">Office</h3>
          <div className="flex flex-col gap-3">
            <a
            ...
            >
              <MapPin className="w-5 h-5 text-white/60 group-hover:scale-110 transition-transform" />
