...
const Footer = () => {
  return (
    <footer className="bg-[#588157] text-[#fafae0] py-6 px-4">
      {/* Quick Links Section */}
      <div className="md:flex items-center pb-4 mb-4">
        <div className="font-bold text-[#fafae0] text-2xl md:mb-0 mb-2 md:mr-4 md:text-left text-center">
          Quick Links
        </div>
        <div className="flex-1 border-b-3 border-black"></div>
      </div>

      {/* Contact Persons Section */}
      <div className="flex md:justify-between justify-evenly items-center flex-wrap space-y-2 space-x-2 md:space-y-0 md:px-5">
        <div className="md:border-b-0 text-center md:text-left font-bold md:border-r-4 border-black pb-4 md:pb-0 md:pr-6">
          <p>CEO</p>
          <p>John Doe</p>
        ...
        <div className="md:border-b-0 text-center md:text-left md:border-r-4 font-bold border-black pb-4 md:pb-0 md:pr-6">
        <p>Support</p>
          <p>Mark Johnson</p>
          <p className="flex justify-center items-center gap-2">
      ...
      <div className="mt-6 flex flex-col md:flex-row justify-between border-t-3 border-black items-center text-center">
