...
<div className="absolute top-2 left-1/2 -translate-x-1/2">
  <div className="relative border-4 border-white md:w-60 md:h-28 w-52 h-20 p-5 rounded-3xl flex items-center bg-[#185519] text-white shadow-2xl transform hover:scale-105 transition-all duration-300 ease-in-out">
    {/* Left Content - "21" */}
...
<h1 className="font-bold md:w-[35vw] mx-auto md:text-3xl text-[23px] text-[#185519] my-5 font-serif">The Leading Hajj & Umrah Travel Company In Pakistan</h1>
